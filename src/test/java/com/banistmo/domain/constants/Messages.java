...
public final class Messages {
    ...
    public static final String PDF_VALIDATION_ERROR = "Error al validar el PDF: ";
    public static final String NAVIGATE_TO_PERSONAS = "{0} navega a la pagina de personas de Bancolombia";
    public static final String SELECT_MENU = "{0} selecciona Productos & Servicios";
